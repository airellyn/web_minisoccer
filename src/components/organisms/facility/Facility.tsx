      ...
      <div className="untree_co-section" id="facility">
        <div className="container">
          ...
          <div className="row align-items-stretch">
            ...
            <div
              className="col-8 col-sm-8 col-lg-4 feature-2-wrap d-md-flex flex-md-column order-lg-1"
            >
            ...
            <div
              className="col-8 col-sm-8 col-lg-4 feature-1-wrap d-md-flex flex-md-column order-lg-3"
            >
              <div className="feature-1 d-md-flex">
                <div className="align-self-center">
